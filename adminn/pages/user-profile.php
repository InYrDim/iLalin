...
<head>
  ...
  <title>Users / Profile - iLalin</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="../../images/logo/logo-ilalin.ico" rel="icon">
  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">         
      ...
      <span class="d-none d-md-block dropdown-toggle pe-2"><?php echo $_SESSION['nama']; ?></span>
        <img src="data:image/jpeg;base64,<?php echo base64_encode($_SESSION['profile_image'])?>"  alt="Profile <?php echo $_SESSION['nama']; ?>" class="rounded-circle">
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <p class="mt-2"><?php echo $_SESSION['email']; ?></p>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="data:image/jpeg;base64,<?php echo base64_encode($_SESSION['profile_image'])?>"  alt="Profile <?php echo $_SESSION['nama']; ?>">
                        <div class="pt-2">

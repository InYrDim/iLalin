        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="py-10 text-center">
                    ...
                    <div>
                        <h3 class="text-lg font-normal text-gray-500 dark:text-gray-400"><?= $alert_message ?></h3>
                        <?php if (isset($alert_body)) { ?>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400 mt-2"><?=$alert_body ?></p>
                        <?php }?>
                    </div>
                </div>
            </div>

                                                    ...
                                                    <div class="w-full flex justify-between">
                                                        ...
                                                        <div class="w-fit space-x-2">
                                                            <button data-driver-id="<?= $trip['driver_id']?>"
                                                                ...
                                                                class="text-black bg-orange-peel-500 py-2 px-4 rounded-lg text-orange-peel-100 ml-auto">Decline</button>

                                                            <button data-driver-id="<?= $trip['driver_id']?>"
                                                                data-trip-id="<?= $trip['trip_id']?>"
                                                                onclick="finishTrip(this);"
                                                                class="text-black bg-como-500 py-2 px-4 rounded-lg text-como-100 ml-auto">Complete</button>
                                                            <script>
                                                            //function to handle trip completion
                                                            function finishTrip(el) {
                                                                ...
                                                                fetch("../controller/php/tripsHandler.php", {
                                                                    ...
                                                                    .then((data) => {
                                                                        ...
                                                                        toast.setAttribute("id", "toast-danger");
                                                                        if (data.status === "success") {
                                                                            ...
                                                                            toast.innerHTML = `
                                                                                    <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-500 bg-red-100 rounded-lg">
                                                                                        <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                                                                            <path d="M18 10a8 8 0 11-16 0h16zm-2 5a6 6 0 11-12 0h12zM7 8a1 1 0 012 0v4a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v4a1 1 0 001 0V8a1 1 0 00-1-1z"></path>
                                                                                        </svg>
                                                                                        <span class="sr-only">Check icon</span>
                                                                                    </div>
                                                                                    <div class="ms-3 text-sm font-normal">${data.message}</div>
